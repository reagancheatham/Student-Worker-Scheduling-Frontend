...
<template>
    ...
    <div class="pt-6 pl-7">
        <UBadge size="lg" color="primary" variant="soft" class="w-80 pl-4">
    ...
    <div class="flex flex-col gap-1 pt-2 pl-10">
        ...
        <div class="flex flex-row pt-8">
            <UButton class="w-75 items-center justify-center p-3 " label="Clock In" size="xl" />
        </div>
        <div class="flex flex-row pt-3">
            <UButton variant="outline" class="w-75 items-center justify-center p-3" label="View Shift Task" size="xl" />
        </div>
    </div>

    <!-- Upcoming Schedule -->
    <div class="pl-6 pt-5 font-bold text-lg">
        Upcoming Shifts
    </div>
    <div>
        <UScrollArea>
